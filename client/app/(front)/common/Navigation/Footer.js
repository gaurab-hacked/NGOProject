    ...
    <footer className="shadow">
      <div className={`mt-0 pt-3 bg-[#2463C1]`}>
        <div className="container mx-auto px-5 pt-5 mb-2">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className={`col-span-4 lg:col-span-4 mb-2 pr-3 lg:pr-5`}>
              <h5 className="text-white font-semibold text-uppercase mb-1">
                Get In Touch
              </h5>
              <p className="mb-1 text-sm font-semibold text-gray-200 w-[80%]">
                Have questions or feedback? We&apos;re here to help! Contact us
                using the info below or our contact form. Well respond promptly.
              </p>
              <div>
                <h6 className="text-white font-semibold text-uppercase mt-2 mb-3">
                  Follow Us:
                </h6>
              ...
              <div className="lg:grid lg:grid-cols-3">
                <div className="mb-5">
                  ...
                  <div className="flex flex-col">
                    <Link
                      href="/our-mission"
                      className={`flex w-[160px] text-sm font-semibold text-gray-200 items-center`}
                    >
                ...
                <div className="mb-5">
                  ...
                  <div className="flex flex-col">
                    ...
                    <Link
                      href="/leadership"
                      className={` flex w-[200px] text-sm font-semibold text-gray-200 items-center`}
                    >
                      <ArrowForwardIosIcon className="!text-xs mr-1" />
                      Leadership
                    </Link>
                ...
                <div>
                  <h5 className="text-white font-semibold text-uppercase">
                    Contact Us:
                  </h5>
                  <div className="flex flex-col space-y-1 ml-1 mt-1">
                    <p className=" flex  text-sm font-semibold text-gray-200 items-center">
                      <MdEmail className="text-white mr-3" />
                      info@des.org.np
                    </p>
                    <p className="mb-0 flex text-sm font-semibold text-gray-200 items-center">
                    ...
                    <Link
                      ...
                      className={`tracking-wide flex text-sm font-semibold text-gray-200 items-center`}
                    >
        ...
        <div className={`w-full flex justify-center items-center`}>
          <p className="pt-2 pb-4 text-center font-semibold text-sm text-gray-200 tracking-wide">
